/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 72b4e540eb0ceaee439ee01cfbc78f1e)
// Runtime types generated with workerd@1.20260910.1 2026-09-12 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	DEFAULT_GATEWAY_ID: "gateway-rev1";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_GATEWAY_ID">> {}
}
