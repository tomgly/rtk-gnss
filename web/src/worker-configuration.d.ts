/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: b2824ac0344e71b0f4f3e32dad6430d9)
...
interface __BaseEnv_Env {
	...
	LIVE_STATUS: DurableObjectNamespace<import("./worker").LiveStatus>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "LiveStatus";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<Cloudflare.Env, "DEVICE_API_TOKEN" | "LOGIN_PASSWORD">
	> {}
}
